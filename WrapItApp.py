...
<style>
    ...
    /* Botones limpios sin emojis coloridos */
    .stRadio > div { gap: 8px; }
    .stRadio label { 
        background-color: #FFFFFF; border: 1px solid #E5E7EB; padding: 10px 15px; 
        border-radius: 8px; width: 100%; transition: 0.2s; font-weight: 500; color: #4B5563;
    }
...
with st.sidebar:
    ...
    # Quitamos los emojis "naquis" de los nombres
...
if not uploaded_file:
    ...
    with col_in:
        user_input = st.text_area("Instrucciones adicionales:", height=150)
